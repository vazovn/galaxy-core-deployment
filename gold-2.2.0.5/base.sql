...
CREATE INDEX g_object_txnid ON g_object (g_transaction_id);
...
CREATE INDEX g_attribute_txnid ON g_attribute (g_transaction_id);
...
CREATE INDEX g_action_txnid ON g_action (g_transaction_id);
...
CREATE INDEX g_transaction_txnid ON g_transaction (g_transaction_id);
...
CREATE INDEX g_system_txnid ON g_system (g_transaction_id);
...
CREATE INDEX g_user_txnid ON g_user (g_transaction_id);
...
CREATE INDEX g_role_txnid ON g_role (g_transaction_id);
...
CREATE INDEX g_role_action_txnid ON g_role_action (g_transaction_id);
...
CREATE INDEX g_role_user_txnid ON g_role_user (g_transaction_id);
...
CREATE INDEX g_password_txnid ON g_password (g_transaction_id);
...
INSERT INTO g_system VALUES ('Gold','2.2.0.5','Beta Release','False',1484308659,1484308659,0,0);

INSERT INTO g_user VALUES ('ANY','Any User','True','False',1484308659,1484308659,0,0);
INSERT INTO g_user VALUES ('NONE','No User','True','False',1484308659,1484308659,0,0);
INSERT INTO g_user VALUES ('SELF','Authenticated User','True','False',1484308659,1484308659,0,0);
INSERT INTO g_user VALUES ('gold','Gold Admin','False','False',1484308659,1484308659,0,0);
