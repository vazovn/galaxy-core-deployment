 ...
 * contents of Validate.xs. Do not edit this file, edit Validate.xs instead.
 *
...
#line 1632 "Validate.c"

XS_EUPXS(XS_Params__Validate__validate); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Params__Validate__validate)
{
    dVAR; dXSARGS;
    if (items != 2)
...
XS_EUPXS(XS_Params__Validate__validate_pos); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Params__Validate__validate_pos)
{
    dVAR; dXSARGS;
    if (items < 1)
       croak_xs_usage(cv,  "p, ...");
...
XS_EUPXS(XS_Params__Validate__validate_with); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Params__Validate__validate_with)
{
    dVAR; dXSARGS;
...
extern "C"
#endif
XS_EXTERNAL(boot_Params__Validate); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Params__Validate)
{
    dVAR; dXSARGS;
    ...
    XS_VERSION_BOOTCHECK;
        ...
        (void)newXSproto_portable("Params::Validate::_validate", XS_Params__Validate__validate, file, "\\@$");
        (void)newXSproto_portable("Params::Validate::_validate_pos", XS_Params__Validate__validate_pos, file, "\\@@");
        newXS("Params::Validate::_validate_with", XS_Params__Validate__validate_with, file);

    /* Initialisation Section */

#line 1483 "Validate.xs"
  bootinit();

#line 1882 "Validate.c"
